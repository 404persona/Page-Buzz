...
const Second = () => {
    ...
    return (
        <div className='md:px-28 md:py-8 md:mt-20' ref={ref}>
            <motion.div
                initial='hidden'
                animate={controls}
                variants={SecondVariants}
                className='flex max-sm:flex-col justify-between items-center md:gap-20'
            >
                <div className='flex justify-center items-center md:w-[50%] max-sm:w-full h-[400px] max-sm:p-6'>
                    <div className='absolute'>
                        <img src="/Secondbg.png" className='sm:max-sm:w-[9000px] md:w-[550px] relative md:top-0 max-sm:w-[400px] max-sm:right-[0px] max-sm:h-[370px] md:right-[px] max-sm:top-[-5px]' />
                    </div>
