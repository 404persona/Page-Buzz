  ...
  return (
    <div className=' h-screen '>
      ...
      max-sm:pt-[300px]  ">
        ...
        <div>
          <div className="absolute md:right-[200px] overflow-hidden inset-0 z-0 ">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <div >
            <div className='flex items-center md:gap-6 max-sm:gap-2 justify-around'>
              <div className="relative z-10 flex flex-col p-4 md:gap-4 max-sm:gap-4 text-white ">
                ...
                <div className="md:text-[3rem] max-sm:text-[2.5rem]  md:w-[500px] md:font-medium bg-clip-text text-transparent leading-tight bg-gradient-to-r from-white to-gray-500 overflow-hidden">
                  <motion.span
                    initial="hidden"
                    animate="visible"
