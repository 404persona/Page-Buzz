...
const Services = () => {
  return (
    <div>
      ...
      <div className='md:px-10 md:py-10 z-10'>
        ...
        <div className='relative z-10'>
          <div className='md:p-20'>
            <div className='border-[1px] p-4 rounded-3xl border-green-500'>
              <div className='bg-[#1E1E21] p-16 flex flex-col justify-center items-center rounded-3xl'>
                ...
                <div className='flex flex-col justify-center gap-6'>
                  <h2 className='text-[4rem] px-10 text-center leading-tight'>Partner with PageBuzz Today!</h2>
                  <p className='text-[.9rem] text-[#929292] px-28 text-center'>Orci at id enim eu pellentesque habitant. Ut at diam suscipit amet id cursus id blandit. Consectetur maecenas id vivamus integer integer aliquam.</p>
